(function(lib){
	...
	controller.MainPage = function(parent) {
    ...
    controller.MainPage.prototype._startSearch = function(val) {
         ...
         try {
            ...
            views.columnView.setColumnFocus(lib.view.TwoColumnView.LEFT);
        }
        catch(e) {
            console.log(e);
        }
    ...
    controller.MainPage.prototype._offerSelected = function(type, index) {
        var offers = this.bookData.getCurrentBook().offers;
        this.listingOpener.openUrl(offers.types[type][index].link);
    }
    
    controller.MainPage.prototype._getOffers = function(book) {
    ...
    controller.MainPage.prototype._bookSelected = function(index) {
        var views = this.views;
        ...
        views.columnView.setColumnFocus(lib.view.TwoColumnView.RIGHT);
	
    }
    
    controller.MainPage.prototype._loadMore = function() {
        var self = this;
        var search = function(books, hasMore) {
            self._search(books, hasMore);
        }
    ...
    controller.MainPage.prototype._search = function(books, hasMore) {
